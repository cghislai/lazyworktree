...
func parseConfigKeys(path string) ([]configKeySpec, error) {
	...
	typeByKey := map[string]string{
		...
		"avatar_badges":                "enum(auto|never|always)",
	...
	defaultByKey := map[string]string{
		...
		"avatar_badges":              defaults["AvatarBadges"],
